...
public class test extends javax.swing.JFrame {
    ...
    private static CallbackMediaPlayerComponent component;
    
   
    
    private static void player (){
            
            component.mediaPlayer().media().startPaused("D:\\Music\\old pen songs\\videos\\Iwamoto - Start Again (Lyrics) ft. Glasscat-360p.mp4");
